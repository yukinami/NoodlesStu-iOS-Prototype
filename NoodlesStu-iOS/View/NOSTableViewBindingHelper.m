...
@interface NOSTableViewBindingHelper () <UITableViewDataSource, UITableViewDelegate>

@end

@implementation NOSTableViewBindingHelper {
...
- (instancetype)initWithTableView:(UITableView *)tableView
  ...
  if (self = [super init]) {
    ...
    [_tableView registerClass:_templateCell.class forCellReuseIdentifier:_templateCell.reuseIdentifier];
    
    // use the template cell to set the row height
    _tableView.estimatedRowHeight = _templateCell.bounds.size.height;
...
+ (instancetype)bindingHelperForTableView:(UITableView *)tableView
  ...
  return [[NOSTableViewBindingHelper alloc] initWithTableView:tableView
                                                sourceSignal:source
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  id<NOSReactiveView> cell = [tableView dequeueReusableCellWithIdentifier:_templateCell.reuseIdentifier];
